        ...
        <div class="flex items-center justify-around">
          ...
          <nav class="flex-1 text-right">
            ...
            <span class="pr-4 text-sm text-grey-300">{{ Auth::user()->name }}</span>
              ...
              ><span class="material-icons md-18 mr-1 mb-1">{{ (Auth::user()->unreadNotifications()->count() == 0) ? 'notifications_none' : 'notifications'}}</span>{{ Auth::user()->unreadNotifications()->count() }}</a>
